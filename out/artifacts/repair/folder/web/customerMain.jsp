...
<li><a href="index.jsp">主页</a></li>
                        <li><a href="#">客户管理</a></li>
                        <li class="active"><a href="#">全部客户</a></li>
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-inline" role="form" action="QueryCustomerByServlet" method="post">
                                        <div class="row">
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover mb0">
                                        ...
                                        <%        CustomerServiceImpl customerService = CustomerServiceImpl.getInstance();
                                            List<Customer> list = (List<Customer>) request.getAttribute("arr");
                                            if (list != null && list.size() == 0) {
                                        %>
                                        <table align="center">
                                            <tr>
                                                <th colspan="10"><font color="red"><h2>客户信息不存在</h2></font></th>
                                            </tr>
                                        </table>
                                        <%
                                        } else {

                                            if (list == null) list = customerService.queryCustomerALl();
                                        ...
                                        %>
                                        <tr>
                                            <th><%=customer.getCurId()%> </th>
                                            <th><%=customer.getCusName()%> </th>
                                            <th><%=customer.getIdnum()%> </th>
                                            <th><%=customer.getCusNature()%> </th>
                                            <th><%=customer.getCusWork()%> </th>
                                            <th><%=customer.getCusTele()%> </th>
                                            <th><%=customer.getCusAdd()%> </th>
                                            <th><%=customer.getCusEmail()%> </th>
                                            <th><%=customer.getCurTime()%> </th>
                                            <th>
                                                <a href="${pageContext.request.contextPath}/customerUpdate.jsp?id=<%=customer.getIdnum()%>">更新</a>
                                                <a href="${pageContext.request.contextPath}/DeleteCustomerServlet?id=<%=customer.getIdnum()%>">删除</a>
                                            </th>
                                        </tr>
                                        <%
                                            }
