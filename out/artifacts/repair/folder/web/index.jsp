		...
		<div class="widget-body welcome-box tabular">
			<div class="tabular-row">
				...
				<div class="tabular-cell welcome-options">
					<span class="welcome-text"><br></br>欢迎您,<a href="#" class="name">${sessionScope.user}&nbsp; &nbsp;&nbsp;    </a></span>
    ...
    %>
		...
		<li><a href="javascript:;"><i class="fa fa-pencil"></i><span>运营监督管理</span></a>
			<ul class="acc-menu">
				...
				<li><a href="GetAllSparesServlet">查询库存</a></li>
        ...
        %>
                ...
                <img src="assets/demo/avatar/zhuye3.png"  width="1295" height="678">
            </div>
        </div>
