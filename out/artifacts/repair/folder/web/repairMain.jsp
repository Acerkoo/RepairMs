...
<li><a href="index.jsp">主页</a></li>
                        <li><a href="#">维修管理</a></li>
                        <li class="active"><a href="#">全部维修信息</a></li>
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-inline" role="form" action="repair.html" method="post">
                                        <div class="row">
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover mb0">
                                        ...
                                        <%
                                            ...
                                            List<Repairinfo> list = (List<Repairinfo>) request.getAttribute("arr");
                                            if (list != null && list.size() == 0) {
                                        %>
                                        <table align="center">
                                            <tr>
                                                <th colspan="10"><font color="red"><h2>维修信息不存在</h2></font></th>
                                            </tr>
                                        </table>
                                        <%
                                        } else {
                                            if(list == null) list = repairImplService.queryAll();
                                            Iterator<Repairinfo> iterator = list.iterator();
                                            while (iterator.hasNext()) {
                                                Repairinfo  repairinfo = iterator.next();
                                        %>
                                        <tr>
                                            <th><%=repairinfo.getId()%></th>
                                            <th><%=repairinfo.getPeople()%></th>
                                            <th><%=repairinfo.getJian()%></th>
                                            <th><%=repairinfo.getWei()%></th>
                                            <th><%=repairinfo.getTimee()%></th>
                                            <th><%=repairinfo.getWorkTime()%></th>
                                            <th><%=repairinfo.getQijian()%></th>
                                            <th><%=repairinfo.getStatus()%></th>
                                            <th>
                                                <a href = "${pageContext.request.contextPath}/UpdateRepairServlet?id=<%=Integer.parseInt(repairinfo.getId())*4+1%>">分配</a>
                                                <a href = "${pageContext.request.contextPath}/UpdateRepairServlet?id=<%=Integer.parseInt(repairinfo.getId())*4+2%>">检测</a>
                                                <a href = "${pageContext.request.contextPath}/UpdateRepairServlet?id=<%=Integer.parseInt(repairinfo.getId())*4+3%>">维修</a>
                                                <a href = "${pageContext.request.contextPath}/DeleteRepairServlet?id=<%=Integer.parseInt(repairinfo.getId())%>">删除</a>
                                            </th>
                                        </tr>
                                        <%
                                                }
