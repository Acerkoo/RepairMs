                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-midnightblue">
                                    ...
                                    <form class="form-horizontal" action="${pageContext.request.contextPath}/UpdateOneRepairServlet" method="post" >
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="horizontal-form">

                                                    <div class="form-group">
                                                        <label for="id" class="col-sm-2 control-label">维修编号</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="people" class="col-sm-2 control-label">维修人员</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="jian" class="col-sm-2 control-label">检测记录</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="jian" name="jian" >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="wei" class="col-sm-2 control-label">维修记录</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="timee" class="col-sm-2 control-label">维修检测时间</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="timee" name="timee"  >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="worktime" class="col-sm-2 control-label">工作量</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="qijian" class="col-sm-2 control-label">维修所用器件</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="qijian"  name="qijian"  >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
