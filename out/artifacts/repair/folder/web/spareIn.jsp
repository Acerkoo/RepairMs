            ...
            <div class="static-content">
                <div class="page-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">备件管理</a></li>
                        <li class="active"><a href="#">追加入库</a></li>
                    </ol>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="alert alert-inverse">
                                    请填写下方表单以追加入库！ <a class="alert-link" href="spareMain.jsp">点此查看所有备件信息</a>!
                                ...
                                <div class="panel panel-midnightblue">
                                    ...
                                    <form class="form-horizontal" action="${pageContext.request.contextPath }/SpareInServlet?number=${param.number}" method="post" >
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="horizontal-form">

                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 control-label">备件名称：</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="ID" class="col-sm-2 control-label">型号：</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="money" class="col-sm-2 control-label">单价：</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="money" name="money" value=${param.money} >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="number" class="col-sm-2 control-label">追加入库数量：</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="number" name="innumber" required>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block">原有数量${param.number}</p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inofwarehouse" class="col-sm-2 control-label">入库时间：</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="inofwarehouse" name="inofwarehouse"   required>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="warnnumber" class="col-sm-2 control-label">警戒值：</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="warnnumber"  name="warnnumber" value=${param.warnnumber}  >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                            ...
                                            <div class="panel-footer">
                                                <div class="row">
                                                    <div class="col-sm-8 col-sm-offset-2">
                                                        <input type="submit" class="btn-primary btn" value="追加入库"></button>
