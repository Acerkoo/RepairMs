...
<html>
<%@ page import="service.repair.RepairImplService" %>
<%@ page import="dao.repair.Repairinfo" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Iterator" %>
<%@ page import="service.prerepair.PreRepairServiceImpl" %>
<%@ page import="dao.prerepair.PreRepair" %>
    ...
    <div class="yamm navbar-left navbar-collapse collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown" id="widget-classicmenu">
                ...
                <>
            <li><a target="_blank">前台</a><>
            <li><a  target="_blank">登录页</a><>
            <li><a  target="_blank">关于吉尼泰美</a><>
            <li class="dropdown" >
...
<div id="wrapper">
                ...
                <div class="sidebar">
                    ...
                    <div class="widget stay-on-collapse" id="widget-sidebar">
                        ...
                        <nav role="navigation" class="widget-body">
                            <ul class="acc-menu">
                                <li><a href="index.jsp?_ijt=683ho4859aojsl55bafftvahqt"><i class="fa fa-home"></i><span>主页</span></a><>
                                        <%
    ...
    %>
                                <li><a href="javascript:;"><i class="fa fa-columns"></i><span>客户管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="customerMain.jsp">全部客户</a><>
                                        <li><a href="customerInsert.jsp">录入客户信息</a><>
                                        <li><a href="customerUpdate.jsp">编辑客户信息</a><>
    ...
    %>
                                <li><a href="javascript:;"><i class="fa fa-flask"></i><span>报修管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="preRepairMain.jsp">查看全部</a><>
                                        <li><a href="preRepairUpdate.jsp">修改报修信息</a><>
                                        <li><a href="preRepairInsert.jsp">录入报修信息</a><>
                                    </ul>
                                    <>
                                        <%
        }
    ...
    %>
                                ...
                                <li><a href="javascript:;"><i class="fa fa-cogs"></i><span>维修管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="repairMain.jsp">全部维修信息</a><>
                                        <li><a href="repairUpdate.jsp">修改维修信息</a><>
                                    </ul>
                                    <>
                                        <%
        }
    ...
    %>
                                <li><a href="javascript:;"><i class="fa fa-cogs"></i><span>任务调度管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="taskQuery.jsp">待分配任务</a><>
                                        <li><a href="taskFun.jsp">一键分配任务</a><>
                                    </ul>
                                    <>
                                        <%
        }
    ...
    %>
                                <li><a href="javascript:;"><i class="fa fa-table"></i><span>结算管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="settlementQuery.jsp">结算账单信息</a><>
                                        <li><a href="settlementInsert.jsp">登记结算信息</a><>
        ...
        %>
                                <li><a href="javascript:;"><i class="fa fa-random"></i><span>备件管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="GetAllSparesServlet">查看仓库信息</a><>
                                        <li><a href="spareInsert.jsp">备件入库</a><>
                                        <li><a href="spareLogMain.jsp">查看仓库流水</a><>
                                    </ul>
                                    <>
                                        <%
            }
        ...
        %>
                                <li><a href="javascript:;"><i class="fa fa-pencil"></i><span>运营监督管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="customerMain.jsp">查询客户信息</a><>
                                        <li><a href="repairMain.jsp">查询维修任务</a><>
                                        <li><a href="spareMain.jsp">查询库存</a><>
                                        <li><a href="settlementQuery.jsp">查询结算信息</a><>
                                    </ul>
                                    <>
                                        <%
            }
        ...
        %>
                                <li><a href="javascript:;"><i class="fa fa-flask"></i><span>账号管理</span></a>
                                    <ul class="acc-menu">
                                        <li><a href="userinfoMain.jsp">全部账号</a><>
                                        <li><a href="userinfoInsert.jsp">注册账号</a><>
                                    </ul>
                                    <>
                                        <%
            }
            ...
            <div class="static-content">
                <div class="page-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="ui-forms1.html">Forms</a></li>
                    </ol>
                    <%
                        ...
                        sessionofOutKu.setAttribute("spareID",ID);
                        sessionofOutKu.setAttribute("spareName",request.getParameter("name"));
                        sessionofOutKu.setAttribute("spareMoney",request.getParameter("money"));
                        sessionofOutKu.setAttribute("spareWarnnumber",request.getParameter("warnnumber"));
                    %>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h2>您正在为型号为"${param.ID}"的产品进行出库！</h2></div>
                                <div class="panel-body">
                                    <form class="form-inline" role="form" action="${pageContext.request.contextPath }/SpareOutServlet?number=${param.number}" method="post">
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    &nbsp;&nbsp;&nbsp;请填写维修编号:
                                                    <label class="sr-only" for="exampleInputEmail2"></label>
                                                    <input type="text" class="form-control" id="exampleInputEmail2" name="fixID">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    &nbsp;&nbsp;&nbsp;请填写出库该型号的数量：
                                                    <label class="sr-only" for="exampleInputEmail2"></label>
                                                    <input type="text" class="form-control" id="exampleInputEmail2" name="outnumber">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    &nbsp;&nbsp;&nbsp;请填写出库日期：
                                                    <label class="sr-only" for="exampleInputEmail2"></label>
                                                    <input type="text" class="form-control" id="exampleInputEmail2" name="outofwarehouse">
                                                </div>
                                            </div>
                                            <div class="form-group">
