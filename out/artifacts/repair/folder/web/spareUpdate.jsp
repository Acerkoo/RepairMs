            ...
            <div class="static-content">
                <div class="page-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">备件管理</a></li>
                        <li class="active"><a href="#">修改备件信息</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-midnightblue">
                                    ...
                                    <form class="form-horizontal" action="${pageContext.request.contextPath }/UpdateSpareServlet" method="post" >
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="horizontal-form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="number" name="number" value=${param.number}   >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="inofwarehouse" name="inofwarehouse" value=${param.inofwarehouse} >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="warnnumber"  name="warnumber" value=${param.warnnumber}  >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                            ...
                                            <div class="panel-footer">
                                                <div class="row">
                                                    <div class="col-sm-8 col-sm-offset-2">
                                                        <input type="submit" class="btn-primary btn" value="修改"></button>
                                                        <input type="reset" class="btn-default btn" value="重置"></input>
                                                    </div>
                                                </div>
                                            </div>
                                        </div></form>
