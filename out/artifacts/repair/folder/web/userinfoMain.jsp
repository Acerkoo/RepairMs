<%@ page import="service.userinfo.UserinfoServiceImpl" %>
<%@ page import="dao.userinfo.Userinfo" %>
...
<%--</head>--%>
<%--<body>--%>
<%--<form action="QueryCustomerByServlet" method="post" align="center">--%>
<%--<table>--%>
...
<%--</tr>--%>
<%--<%--%>
<%--UserinfoServiceImpl usi = UserinfoServiceImpl.getInstance();--%>
<%--List<Userinfo> list = (List<Userinfo>) request.getAttribute("arr");--%>
<%--if (list == null) list = usi.queryUserinfoAll();--%>
...
<%--<th><%=userinfo.getUsername()%> </th>--%>
<%--<th><%=userinfo.getPassword()%> </th>--%>
<%--<th><%=userinfo.getPosition()%> </th>--%>
<%--<th>--%>
<%--<a href="${pageContext.request.contextPath}/UpdateUserinfoServlet?id=<%=userinfo.getUserid()%>">修改</a>--%>
<%--<a href="${pageContext.request.contextPath}/DeleteUserinfoServlet?id=<%=userinfo.getUserid()%>">删除</a>--%>
<%--</th>--%>
<%--</tr>--%>
<%--<%--%>
<%--}--%>
    ...
    <div id="layout-static">
        ...
        <div class="page-content">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">账户管理</a></li>
                <li class="active"><a href="#">全部账号信息</a></li>
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-inline" role="form" action="QueryUserinfoServlet" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <button type="post" class="btn btn-primary">查询</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <table class="table table-hover mb0">
                            ...
                            <table align="center">
                                <tr>
                                    <th colspan="10"><font color="red"><h2>账号信息不存在</h2></font></th>
                                </tr>
                            </table>
                            <%
                            } else {
                            ...
                            <th><%=userinfo.getPosition()%> </th>
                            <th>
                            <a href="${pageContext.request.contextPath}/userinfoUpdate.jsp?id=<%=userinfo.getUserid()%>">修改</a>
                            <a href="${pageContext.request.contextPath}/DeleteUserinfoServlet?id=<%=userinfo.getUserid()%>">删除</a>
                            </th>
                            </tr>
                            <%
