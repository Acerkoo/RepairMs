...
<li><a href="index.jsp">主页</a></li>
                        <li><a href="#">报修管理</a></li>
                        <li class="active"><a href="#">查看全部</a></li>
                    </ol>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-inline" role="form" action="QueryRRbyIdServlet" method="post">
                                        <div class="row">
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover mb0">
                                        ...
                                        <%
                                            ...
                                            List<PreRepair> list = (List<PreRepair>) request.getAttribute("arr");
                                            if (list != null && list.size() == 0) {
                                        %>
                                        <table align="center">
                                            <tr>
                                                <th colspan="10"><font color="red"><h2>报修信息不存在</h2></font></th>
                                            </tr>
                                        </table>
                                        <%
                                        } else {
                                            if (list == null) list = rrsi.getAllRepairRecord();
                                            Iterator<PreRepair> iterator = list.iterator();
                                            while (iterator.hasNext()) {
                                                PreRepair preRepair = iterator.next();
                                        %>
                                        <tr>
                                            <th><%=preRepair.getRepairnumber()%> </th>
                                            <th><%=preRepair.getCustomernumber()%> </th>
                                            <th><%=preRepair.getProducttype()%> </th>
                                            <th><%=preRepair.getFaulttype()%> </th>
                                            <th><%=preRepair.getEstimateprice()%> </th>
                                            <th><%=preRepair.getRepairstatus()%> </th>
                                            <th>
                                                <a href="${pageContext.request.contextPath}/CheckConfirmServlet?id=<%=preRepair.getRepairnumber()%>">确认</a>
                                                <a href="${pageContext.request.contextPath}/CheckPrintServlet?id=<%=preRepair.getRepairnumber()%>">打印</a>
                                                <a href="${pageContext.request.contextPath}/preRepairUpdate.jsp?id=<%=preRepair.getRepairnumber()%>">编辑</a>
                                                <a href="${pageContext.request.contextPath}/DeleteRRByIdServlet?id=<%=preRepair.getRepairnumber()%>">删除</a>
                                            </th>
                                        </tr>
                                        <%
                                            }
