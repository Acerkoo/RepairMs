...
<%--<form action="querySettlementByIdServlet" method="post" align="center">--%>
    <%--<input type="text" name="wid" value="维修单号">--%>
    ...
    <%--<table>--%>
        ...
        <%--<tr>--%>
            ...
            <%--<th>--%>
                <%--<a href="${pageContext.request.contextPath}/insertSettlementServlet?id=${settlement.getwid()}">结算</a>--%>
            <%--</th>--%>
        <%--</tr>--%>
        <%--<%--%>
            <%--}--%>
    ...
    <div id="layout-static">
        ...
        <div class="page-content">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">结算管理</a></li>
                <li class="active"><a href="#">登记结算信息</a></li>
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            SettlementServiceImpl customerService = SettlementServiceImpl.getInstance();
                            List<Settlement> list = (List<Settlement>) request.getAttribute("settlement");
                                if (list != null && list.size() == 0) { //经过查询但未查询的结果
                            %>
                                <table align="center">
                                    <tr>
                            ...
                            if (list == null) list = customerService.querySettlementAll(); //未经过查询，默认显示全部信息
                            Iterator<Settlement> iterator = list.iterator();
                            while (iterator.hasNext()) {
                            Settlement settlement = iterator.next();
                            %>
