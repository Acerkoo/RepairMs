<%@ page import="dao.settlement.Settlement" %>
<%@ page import="service.settlement.SettlementServiceImpl" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Iterator" %>
<%@ page import="service.customer.CustomerServiceImpl" %>
<%@ page import="dao.customer.Customer" %>
...
<%--</head>--%>
<%--<body>--%>
<%--<form action="querySettlementByIdServlet" method="post" align = "center">--%>
...
<%--</tr>--%>
<%--<%--%>
<%--SettlementServiceImpl customerService = SettlementServiceImpl.getInstance();--%>
<%--List<Settlement> list = (List<Settlement>) request.getAttribute("settlement");--%>
<%--if (list == null) list = customerService.querySettlementAll();--%>
<%--Iterator<Settlement> iterator = list.iterator();--%>
<%--while (iterator.hasNext()) {--%>
<%--Settlement settlement= iterator.next();--%>
<%--%>--%>
<%--<tr>--%>
<%--<th><%=settlement.getwId()%> </th>--%>
<%--<th><%=settlement.getwPeoPrice()%> </th>--%>
<%--<th><%=settlement.getwPartPrice()%> </th>--%>
<%--<th><%=settlement.getWpromise()%> </th>--%>
<%--<th><%=settlement.getCareThing()%> </th>--%>
<%--<th><%=settlement.getBillDate()%> </th>--%>
<%--</tr>--%>
<%--<%--%>
<%--}--%>
<%--%>--%>
    ...
    <div id="layout-static">
        ...
        <div class="page-content">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">结算管理</a></li>
                <li class="active"><a href="#">未结算账单信息</a></li>
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-inline" role="form" action="querySettlementByIdServlet" method="post">
                                <div class="row">
            ...
            <div class="row">
                ...
                List<Settlement> list = (List<Settlement>) request.getAttribute("settlement");
                                ...
                                <table align="center">
                                    <tr>
                                        <th colspan="10"><font color="red"><h2>账单信息不存在</h2></font></th>
                                    </tr>
                                </table>
                                    <%
                                        } else {
...
<!-- Maps -->
<script src="assets/plugins/jQuery-Mapael/js/raphael/raphael-min.js"></script>
<!-- Load Raphael as Dependency -->
...
<!-- Mousewheel Support in zoomed-in maps -->
<script src="assets/plugins/jQuery-Mapael/js/maps/world_countries.js"></script>
<!-- Vector Data of World Countries -->
