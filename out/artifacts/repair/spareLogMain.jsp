<%@ page import="dao.warehouse.SpareLogDaoImpl" %>
<%@ page import="dao.warehouse.SpareLog" %>
            ...
            <div class="static-content">
                <div class="page-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">备件管理</a></li>
                        <li class="active"><a href="#">备件流水信息查询</a></li>
                    </ol>
                    <div class="row">
                        <div class="col-xs-12">
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover mb0">
                                        ...
                                        <%
                                            ...
                                            List<SpareLog> list = (List<SpareLog>) request.getAttribute("arr");
                                            if (list == null) list = spareLogService.getAllSpareLog();
                                            Iterator<SpareLog> iterator = list.iterator();
                                            while (iterator.hasNext()) {
                                                SpareLog sparelog= iterator.next();
                                        %>
                                        <tr>
                                            <th><%=sparelog.getName()%> </th>
                                            <th><%=sparelog.getID()%> </th>
                                            <th><%=sparelog.getFixID()%> </th>
                                            <th><%=sparelog.getNumber()%> </th>
                                            <th><%=sparelog.getMoney()%> </th>
                                            <th><%=sparelog.getOutofwarehouse()%> </th>
                                        </tr>
                                        <%
                                            }
                                        %>
