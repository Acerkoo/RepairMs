    ...
    <ul class="nav navbar-nav toolbar pull-right">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle username" data-toggle="dropdown">
                ...
                <form action="LogoutServlet" method="post" align="center">
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type = "submit"  class="btn btn-midnightblue-alt btn-sm" name="Logout" value="注销">
                </form>
            ...
            <div class="static-content">
                <div class="page-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">客户管理</a></li>
                        <li class="active"><a href="#">录入客户信息</a></li>
                    </ol>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="alert alert-inverse">
                                    请填写下方表单以添加用户！ <a class="alert-link" href="customerMain.jsp">点此查看所有用户</a>!
                                ...
                                <div class="panel panel-midnightblue">
                                    ...
                                    <form class="form-horizontal" action="CustomerInsertServlet" method="post" >
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="horizontal-form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control" id="source" name="methods" require>
                                                                <option value="family">家庭用户</option>
                                                                <option value="company">单位用户</option>
                                                                <option value="daili">代理商</option>
                                                                <option value="qianyue">签约用户</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="money" class="col-sm-2 control-label">工作</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="money" name="work" >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="number" name="tele"  >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inofwarehouse" class="col-sm-2 control-label">地址</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="inofwarehouse" name="addr"  >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="warnnumber" class="col-sm-2 control-label">邮箱</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="warnnumber"  name="email"  >
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <p class="help-block"></p>
                                                        </div>
                                            ...
                                            <div class="panel-footer">
                                                <div class="row">
                                                    <div class="col-sm-8 col-sm-offset-2">
                                                        <input type="submit" class="btn-primary btn" value="确定"></button>
