...
<%--</head>--%>
<%--<body>--%>
<%--<form action="repair.html" method="post" align="center">--%>
...
<%--if (list == null) list = ris.queryByStatus("0");--%>
    ...
    <div id="layout-static">
        ...
        <div class="page-content">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">任务调度</a></li>
                <li class="active"><a href="#">待分配任务</a></li>
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="ScheduleServlet" method="post" align="center">
                                <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <table class="table table-hover mb0">
                            ...
                            <table align="center">
                                <tr>
                                    <th colspan="10"><font color="red"><h2>无维修信息</h2></font></th>
                                </tr>
                            </table>
                                <%
                                        } else {
